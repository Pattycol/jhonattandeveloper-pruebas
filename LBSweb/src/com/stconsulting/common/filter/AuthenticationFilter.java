 ...
 *
 * Created on 19 de enero de 2004, 11:41 AM
 */

package com.stconsulting.common.filter;
...
public class AuthenticationFilter implements Filter{
	...
	public AuthenticationFilter(){
		log.debug("AL INICIO DEL FILTRO *******************");
	}
	...
	private void doBeforeProcessing(ServletRequest request,ServletResponse response) throws IOException{
		...
		/*else{
			if(session.getAttribute(Constants.USUARIO_LOGUEADO) == null)
				((HttpServletResponse) response).sendRedirect(loginPage);
		}*/
	}
