 ...
 *
 * Created on 23 de diciembre de 2003, 11:33 AM
 */
...
public class PooledConnectionFactory{
	...
	private PooledConnectionFactory() throws ClassNotFoundException{
		...
		java.util.ResourceBundle bundle=java.util.ResourceBundle.getBundle("com.stconsulting.resource.connection");
		...
		pcf=new PoolableConnectionFactory(dmcf,pool,null,null,false,true);
