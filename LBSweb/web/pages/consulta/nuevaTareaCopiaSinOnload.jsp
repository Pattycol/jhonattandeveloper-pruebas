...
<!-- jQuery DateTimePicker-->
    ...
    function cargar() {
    	//alert("Entro en el Cargar Nueva TAREA Copia Sin Onload ");
...
function cargaGrafico(){
	alert("CargaGrafico de la Nueva Tarea Copia Sin Onload");
  // goFrameDer('ConsultaTarea.do?method=mapa');
    goMethodDemo(1,'ConsultaTarea','mapa');
}
<% if(activaGrafico!=null){
	System.out.println("Dentro del If ..en Nueva Tarea Copia Sin Onload");
%>
      cargaGrafico();
<%}%>     
</script>
...
<!-- 	<a href="javascript:abrirAyudaFormato()" class="vinculomenu" title='Ayuda acerca del formato de los números'>Ayuda</a> -->
   ...
   <tr>
    ...
    <%if(nuevaTarea.equals(Constants.MODIFICAR_TAREA)  || nuevaTarea.equals(Constants.CONFIRMAR_TAREA)){%>
    	...
    	<input styleClass="labelRespuesta"  name="fechaInicioString" value="<%=fechaIni%>" disabled="true"  id="txtfecInicio" readonly="readonly" maxlength="10" >
    <%}else{ %>
    	
    	<input styleClass="labelRespuesta"  name="fechaInicioString" value="<%=fechaIni%>"  id="txtfecInicio" readonly="readonly" maxlength="10"  >
    <%} %>
    </td>
  </tr>
  <tr>
	...
	<%if(nuevaTarea.equals(Constants.MODIFICAR_TAREA)  || nuevaTarea.equals(Constants.CONFIRMAR_TAREA)){%>
		...
		<input styleClass="labelRespuesta"  name="fechaFinString" value="<%=fechaFi%>" id="txtfecFin" disabled="true"  readonly="readonly" maxlength="10" />
	<%}else{%>
	
		<input styleClass="labelRespuesta"  name="fechaFinString" value="<%=fechaFi%>"  id="txtfecFin"  readonly="readonly" maxlength="10" />
  ...
  <tr>
    ...
    <%if(nuevaTarea.equals(Constants.MODIFICAR_TAREA)  || nuevaTarea.equals(Constants.CONFIRMAR_TAREA)){%>
    	...
    	<nested:text property="horaInicio" disabled="true"  maxlength="10" />
    <%}else{ %>
  ...
  <tr>
	...
	<%if(nuevaTarea.equals(Constants.MODIFICAR_TAREA)  || nuevaTarea.equals(Constants.CONFIRMAR_TAREA)){%>
		...
		<nested:text property="horaFin" disabled="true"  maxlength="10" />
	<%}else{%>
