...
<body>
	...
	<table cellpadding="0" cellspacing="0"
		...
		<tr>
			<td valign="middle"><html:form action="/login">
										...
										<tbody>
											<tr class="icePnlGrdRow1">
												...
												<td class="icePnlGrdCol2" id="formDatos:_idJsp40-0-1">
													<html:text property="usuario" size="25" maxlength="50" />
												</td>
											</tr>
											<tr class="icePnlGrdRow2">
												...
												<td class="icePnlGrdCol2" id="formDatos:_idJsp40-1-1">
													<html:text property="clave" size="25" maxlength="50" />
												</td>
											</tr>
											<tr class="icePnlGrdRow1">
							...
							<tr class="icePnlGrdRow1">
								<td class="icePnlGrdCol1" id="formDatos:_idJsp29-4-0"><span
									...
									style="width: 370px; FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Arial, Helvetica, sans-serif; TEXT-ALIGN: justify">Ingrese
										su c&oacute;digo de usuario asignado y la contrase&ntilde;a
										para iniciar sesi&oacute;n en el sistema.</span></td>
							</tr>
							<tr class="icePnlGrdRow2">
					...
					<div id="formDatoshdnFldsDiv">
						<input name="focus_hidden_field" type="hidden" />
					</div>
				</html:form></td>
		</tr>
