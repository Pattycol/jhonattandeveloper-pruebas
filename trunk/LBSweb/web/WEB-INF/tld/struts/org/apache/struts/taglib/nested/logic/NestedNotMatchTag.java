 ...
 *  Generated tag class.
 */
public class NestedNotMatchTag extends BodyTagSupport {
    ...
    /**
     * property declaration for tag attribute: location.
     */    
    ...
    public void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("error in NestedNotMatchTag: " + ex);
    }
