    ...
    public static int getPropiedadInt(String propiedad){
            ...
            if(prop != null)
                    try{
                    	...
                    	Log.info(numberformatexception.toString());
                    }
            return valor;
    }
    ...
    public static void cargarConfiguracion(String archivo){
            ...
            try{
                    ...
                    if(archivo != null && !archivo.equals("")){
                            ...
                            //is=Config.class.getResourceAsStream("/mensajes.properties");
                    		
                    	//is=Config.class.getResourceAsStream("C:/Users/user/Desktop/test/prueba.properties");
                    	is = new FileInputStream("C:/Users/user/Desktop/test/prueba.properties");
