...
public class LBSConsultaServiceService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(com.hildebrando.claro.WSLBS.CLBSConsultaService.LBSConsultaServiceService.class
					.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = com.hildebrando.claro.WSLBS.CLBSConsultaService.LBSConsultaServiceService.class
					.getResource(".");
			url = new URL(baseUrl,
